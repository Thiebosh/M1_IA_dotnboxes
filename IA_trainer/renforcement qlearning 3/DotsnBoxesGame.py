...
class Game:
    ...
    def decide_and_move(self, id_chosen_move):
        ...
        reward = 0 if sum(self.score) == 0 else self.score[0 if is_player1 else 1] / sum(self.score)
        ...
        return is_player1, self.lineboard.copy(), reward, len(self.moves_remaining) == 0
